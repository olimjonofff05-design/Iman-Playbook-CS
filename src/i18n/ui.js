...
export const ui = {
  uz: {
    ...
    cards: {
      ...
      investCalc: { title: "Invest kalkulyator", desc: "Muddatidan oldin chiqishda beriladigan summa" },
    ...
    pages: {
      ...
      investCalc: {
        title: "Invest kalkulyator",
        subtitle: "Investor sarmoyani muddatidan oldin qaytarib olganda foydadan qancha beriladi va qancha ushlab qolinadi — avtomatik hisob.",
        inputsTitle: "Operator kiritadi",
        resultsTitle: "Avtomatik hisoblanadi",
        term: "Sarmoya qo'yilgan muddat",
        months: "Necha oy turgani",
        profit: "Umumiy olgan foydasi",
        monthUnit: "oy",
        currency: "so'm",
        give: "Investorga beriladigan summa",
        keep: "Ushlab qolinadigan summa",
        giveFormula: "Umumiy foyda × Turgan oy ÷ Muddat",
        keepFormula: "Umumiy foyda − Beriladigan summa",
        percent: "Foydaning necha foizi beriladi / ushlab qolinadi",
        givePercent: "Beriladi",
        keepPercent: "Ushlab qolinadi",
        clear: "Tozalash",
        errTerm: "Qo'yilgan muddat 0 dan katta bo'lishi kerak.",
        errMonths: "Necha oy turgani noto'g'ri kiritilgan.",
        errMonthsGreater: "Turgan oylar soni qo'yilgan muddatdan katta bo'lishi mumkin emas.",
        errProfit: "Umumiy foyda noto'g'ri kiritilgan.",
      },
      qa: {
        title: "QA fikrlari",
  ...
  ru: {
    ...
    cards: {
      ...
      investCalc: { title: "Invest калькулятор", desc: "Сумма к выплате при досрочном выходе" },
    ...
    pages: {
      ...
      investCalc: {
        title: "Invest калькулятор",
        subtitle: "Сколько прибыли выплачивается и сколько удерживается, если инвестор забирает вложение досрочно — автоматический расчёт.",
        inputsTitle: "Вводит оператор",
        resultsTitle: "Рассчитывается автоматически",
        term: "Срок вложения",
        months: "Сколько месяцев простояло",
        profit: "Общая полученная прибыль",
        monthUnit: "мес.",
        currency: "сум",
        give: "Сумма к выплате инвестору",
        keep: "Удерживаемая сумма",
        giveFormula: "Общая прибыль × Прошло мес. ÷ Срок",
        keepFormula: "Общая прибыль − Сумма к выплате",
        percent: "Сколько процентов прибыли выплачивается / удерживается",
        givePercent: "Выплачивается",
        keepPercent: "Удерживается",
        clear: "Очистить",
        errTerm: "Срок вложения должен быть больше 0.",
        errMonths: "Количество месяцев введено неверно.",
        errMonthsGreater: "Прошедшие месяцы не могут быть больше срока вложения.",
        errProfit: "Общая прибыль введена неверно.",
      },
      qa: {
        title: "Отзывы QA",
