...
export const bnplOverview = {
  ...
  restrictions: {
    uz: [
      ...
      "To'lov 3 kalendar kundan kechiksa, mijozga qo'shimcha 3 kun beriladi; kechikish 90 kunga yetsa, shartnoma bekor qilinib, qolgan qarz umumiy undiruvga o'tkaziladi",
    ...
    ru: [
      ...
      "При просрочке платежа более 3 календарных дней клиенту даётся ещё 3 дня; при просрочке до 90 дней договор расторгается, а остаток задолженности передаётся в общее взыскание",
